...
A házi feladatok leírása csak a félév folyamán fokozatosan, a meghirdetésük után kerülnek behivatkozásra a hallgatók számára a github.io menürendszerében. Addig a laborvezetők számára az alábbi hivatkozások alatt érhetők el:

- [Házi feladat munkafolyamat és Git/GitHub használata](../hazi/hf-folyamat/index.md)
