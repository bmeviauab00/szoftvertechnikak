...
1. Futtassuk az alkalmazást (pl. az **F5** billentyű használatával). A kód felépítése nagyon hasonlít a Java-hoz, illetve a C++-hoz. Az osztályaink névterekbe szervezettek. Névtereket hatókörbe „hozni” a using kulcsszóval tudjuk. Névteret definiálni a namespace kulcsszóval tudunk.
...
!!! note  "Top level statements és Implicit usings"
...
!!! Note "Inconsistent visibility vagy inconsistent accessibility hiba"
...
!!! Note
    Megjegyzés: ha a Class Diagram elem nem jelenik meg a listában, akkor nincs telepítve a VS megfelelő komponense. Erről jelen dokumentum [Előfeltételek](#elofeltetelek) fejezetében olvashatsz bővebben.
...
!!! Note "Interfészben alapértelmezett implementáció megadása"
...
<!-- <img src="images/class-diagram-eqipmentbase-sc-hd.png" alt="drawing"/> -->
<!-- Ez működött, a gyökér CSS módosítással>

<!-- <span class="xxx">
        <img class="yyy" src="images/class-diagram-eqipmentbase-sc-hd.png"/>
    </span> -->

<!-- <figure markdown>
  ![EquipmentBase és HardDisk/SoundCard](images/class-diagram-eqipmentbase-sc-hd.png){ width="300" }
</figure> -->
